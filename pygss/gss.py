...
# This file was created automatically by SWIG., then modified by hand
import gssc
import types
...
class gssContextPtr :
    ...
    def init(self,arg0,arg1,arg2,arg3,arg4,arg5,arg6):
        val = gssc.gssContext_init(self.this,arg0.this,arg1.this,arg2,arg3,arg4,arg5,arg6)
        return tuple(val)
    def accept(self,arg0,arg1,arg2):
        val = gssc.gssContext_accept(self.this,arg0.this,arg1,arg2)
        # src_name
        val[1]=gssNamePtr(val[1])
        val[1].thisown=1
        # deleg cred
        val[6]=gssCredPtr(val[6])
        return tuple(val)
    ...
    def unwrap(self,arg0):
        ...
        return val
    def get_mic(self,arg0,arg1):
        val = gssc.gssContext_get_mic(self.this,arg0,arg1)
        return val
    def verify_mic(self,arg0,arg1):
        val = gssc.gssContext_verify_mic(self.this,arg0,arg1)
        return val
    def inquire(self):
